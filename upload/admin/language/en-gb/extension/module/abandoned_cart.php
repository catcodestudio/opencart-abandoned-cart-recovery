...
$_['help_cron']              = 'Registered with the OpenCart cron list automatically where the store has one. For minute-level accuracy point a system cron at this URL, for example every 15 minutes.';
