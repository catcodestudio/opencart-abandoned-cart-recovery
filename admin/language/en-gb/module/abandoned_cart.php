...
// Pro: Viber / SMS (TurboSMS)
$_['tab_sms']               = 'Viber / SMS';
$_['entry_sms_enabled']     = 'Send Viber / SMS reminders';
$_['entry_turbosms_token']  = 'TurboSMS token';
$_['entry_sms_channel']     = 'Channel';
$_['entry_viber_sender']    = 'Viber sender';
$_['entry_sms_sender']      = 'SMS sender (alpha name)';
$_['entry_sms_delay']       = 'Minutes after the cart is abandoned';
$_['entry_sms_quiet']       = 'Quiet hours (do not send)';
$_['entry_sms_text']        = 'Message text';
$_['entry_sms_test']        = 'Test message';
$_['text_channel_hybrid']   = 'Viber, SMS if not delivered';
$_['text_channel_viber']    = 'Viber only';
$_['text_channel_sms']      = 'SMS only';
$_['button_sms_balance']    = 'Check connection';
$_['button_sms_test']       = 'Send test';
$_['text_sms_balance']      = 'Connected. TurboSMS balance: %s UAH.';
$_['text_sms_test_sent']    = 'TurboSMS accepted the test message to %s.';
$_['text_sms_test_name']    = 'Olena';
$_['text_msg_label']        = 'Viber/SMS:';
$_['text_sms_body']         = '{store_name}: you left items worth {cart_total} in your cart. It is saved for you: {recovery_link}';
$_['help_sms_intro']        = 'One Viber or SMS message per abandoned cart where the shopper left a phone number, even without an e-mail. Sent through TurboSMS: you need an account, an API token and registered sender names. The e-mail chain keeps running separately.';
$_['help_turbosms_token']   = 'turbosms.ua → Settings → API: copy the token. Stored encrypted.';
$_['help_sms_channel']      = 'Viber is cheaper and shows the link as a button; for numbers without Viber TurboSMS falls back to SMS.';
$_['help_sms_sender']       = 'Sender names must be registered and active in your TurboSMS account, otherwise the API answers 400/401.';
$_['help_sms_delay']        = 'Counted from the moment the cart is marked abandoned. The reminder is sent once.';
$_['help_sms_quiet']        = 'Hours in the store timezone. 21 — 9 means nothing is sent between 21:00 and 9:00; the message goes out in the morning. Equal values disable the window.';
$_['help_sms_text']         = 'Variables: {customer_name}, {store_name}, {cart_total}, {item_count}, {recovery_link}, {coupon_code}. Keep SMS short: Cyrillic text is billed per 70 characters.';
$_['help_sms_test']         = 'Sends a real, billed message with the values currently in the form (even unsaved).';
$_['error_sms_token']       = 'Enter the TurboSMS token.';
$_['error_sms_phone']       = 'Enter a Ukrainian number in the +380XXXXXXXXX format.';
$_['error_sms_api']         = 'TurboSMS rejected the request:';
